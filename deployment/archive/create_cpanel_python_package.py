...
'''
        ...
        # .htaccess compatible O2Switch et hébergement mutualisé
        htaccess_content = '''# OpenRed cPanel - Configuration compatible hébergement mutualisé

# Page d'accueil par défaut
DirectoryIndex index.html app.py
...
# Autoriser l'accès aux fichiers web
<Files "*.html">
    Order Allow,Deny
    Allow from all
</Files>
